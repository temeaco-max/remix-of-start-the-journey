...
Repository-side implementation and convergence ledger. External/device activation items remain open until independently evidenced.
...
- [ ] Real-device push notification delivery with Firebase credentials and physical build
- [ ] Real WhatsApp/Telegram linked-device pairing and inbound/outbound delivery
- [ ] Stripe production/test settlement, refund, dispute and reconciliation rehearsal with external credentials
- [ ] Production durable database/queue activation and multi-worker migration
- [ ] Provider onboarding/identity verification and real fulfilment operations
- [ ] Routable private-number masking with approved telephony provider
- [ ] Production object storage/malware scanning
- [ ] WebRTC relay/STUN/TURN operations
- [ ] MQTT/IoT broker and device operations
