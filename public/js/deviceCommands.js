const deviceTemplates = {
  samsung_tv: {
    ...
    commands: {
      power: {
        type: "http",
        path: "/api/v2/remote/control?action=power",
        method: "POST",
        label: "Power",
      },
      volume_up: {
        type: "http",
        path: "/api/v2/remote/control?action=vol_up",
        method: "POST",
        label: "Vol +",
      },
      volume_down: {
        type: "http",
        path: "/api/v2/remote/control?action=vol_down",
        method: "POST",
        label: "Vol -",
      },
      channel_up: {
        type: "http",
        path: "/api/v2/remote/control?action=ch_up",
        method: "POST",
        label: "CH +",
      },
      channel_down: {
        type: "http",
        path: "/api/v2/remote/control?action=ch_down",
        method: "POST",
        label: "CH -",
      },
    },
