...
(() => {
  ...
  const STAGE_FOR_STATUS = {
    ...
    information: "working",
    waiting: "waiting",
    "externally-pending": "waiting",
    externally_pending: "waiting",
    "pending-external-evidence": "waiting",
    "needs-user": "needs-you",
    needs_user: "needs-you",
    needsinput: "needs-you",
    "needs-input": "needs-you",
    "needs-you": "needs-you",
    confirmation_required: "needs-you",
    confirmationrequired: "needs-you",
    complete: "done",
    done: "done",
    success: "done",
    completed: "done",
  ...
  function showReturningUser(target) {
    const container =
      target || document.getElementById("chat-content") || document.querySelector(".chat-shell");
    if (!container) return;
