...
type DiscoverItem = { id: string; type: "discovery" | "topic" | "capability"; title: string; detail: string; verified?: boolean; available?: boolean; distanceMetres?: number; lifecycle?: string; actions?: string[]; chatAction?: { id?: string; prompt?: string } };
