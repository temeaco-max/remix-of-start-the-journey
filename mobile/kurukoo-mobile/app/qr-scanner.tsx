        ...
        {!permission?.granted ? (
          ...
          <View style={styles.cameraWrap}>
            ...
            <View pointerEvents="none" style={styles.overlay}>
              ...
              <Text style={styles.overlayText}>Align the QR inside the frame</Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  permissionCard: { borderWidth: 1, borderRadius: 18, padding: 16, gap: 9 },
  title: { fontFamily: "SpaceGrotesk_600SemiBold", fontSize: 18, lineHeight: 24 },
  cameraWrap: { flex: 1, minHeight: 420, borderRadius: 22, overflow: "hidden", position: "relative", backgroundColor: "#111" },
  camera: { flex: 1 },
  overlay: { ...StyleSheet.absoluteFillObject, alignItems: "center", justifyContent: "center", gap: 14 },
  scanFrame: { width: 230, height: 230, borderWidth: 2, borderRadius: 24, backgroundColor: "transparent" },
  overlayText: { color: "#fff", fontFamily: "Inter_600SemiBold", fontSize: 13, backgroundColor: "#0008", paddingHorizontal: 10, paddingVertical: 6, borderRadius: 999 },
  processing: { ...StyleSheet.absoluteFillObject, alignItems: "center", justifyContent: "center", backgroundColor: "#0008", gap: 8 },
  processingText: { color: "#fff", fontFamily: "Inter_600SemiBold" },
  primaryButton: { minHeight: 46, borderRadius: 12, alignItems: "center", justifyContent: "center", paddingHorizontal: 16 },
  primaryText: { color: "#fff", fontFamily: "Inter_700Bold", fontSize: 14 },
  secondaryButton: { minHeight: 44, borderWidth: 1, borderRadius: 12, alignItems: "center", justifyContent: "center", paddingHorizontal: 16 },
