...
const result = { status: issues.length ? 'blocked' : warnings.length ? 'warning' : 'ready', production, cloudRunDetected, databaseMode, jobMode, workers, postgresApplicationIntegrated, postgresClientInstalled, issues, warnings };
