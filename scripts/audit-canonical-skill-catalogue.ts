...
if (report.coreCount !== 208) throw new Error(`Canonical core skill count changed unexpectedly: expected 208, found ${report.coreCount}`);
if (report.canonicalCount < 244) throw new Error(`Canonical catalogue regressed below 244 skills: found ${report.canonicalCount}`);
