...
assert.match(convergence, /payment success requires provider evidence/i, 'Economic UI must preserve evidence-gated payment semantics.');
assert.match(convergence, /data-kurukoo-app-convergence/, 'The convergence script must be self-identifying to avoid duplicate loads.');
