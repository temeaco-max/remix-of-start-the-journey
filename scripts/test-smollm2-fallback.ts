...
console.log(JSON.stringify({ ok: true, model: status.model, source: status.source, readiness: status.readiness, lastFailure: status.lastFailure, preview: text.slice(0, 160) }, null, 2));
