...
const moreItems = [
  ...
  ["/integrations", "Integrations", Radio],
  ["/capabilities", "Capabilities", Zap],
  ["/opportunities", "Opportunities", Zap],
  ["/businesses", "Providers", Users],
  ["/network", "Businesses", Store],
  ["/network", "Creators", Sparkles],
  ["/ad-campaign", "Advertising", Zap],
        ...
        <>
          ...
          >
            ...
            <div className="mt-6 rounded-2xl border border-border bg-brand-tint/35 p-3">
              <p className="text-[11px] font-medium leading-4">Discover more</p>
              <p className="mt-1 text-[10.5px] leading-5 text-muted-foreground">
                Guides, connections and more.
              </p>
            </div>
            <nav
