...
function OsHeader() {
  ...
  return <header className="sticky top-0 z-50 border-b border-border/70 bg-background/95 backdrop-blur">
    <div className="flex h-[50px] items-center gap-4 px-5 md:px-7 lg:px-8">
      <Link to="/desk" className="flex shrink-0 items-center gap-2" aria-label="Kurukoo For You"><span className="grid size-8 place-items-center rounded-[11px] bg-[#f4e6dc] text-[14px] font-semibold text-[#765443]" aria-hidden>K</span><span className="hidden text-[17px] font-semibold tracking-[-0.025em] sm:inline">Kurukoo</span></Link>
