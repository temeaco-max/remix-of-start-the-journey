...
const railSearchItems = [
  ...
  { title: "Cart", detail: "Items ready for review", icon: ShoppingCart, to: "/cart" },
...
function TrustedContextRail({ open, onOpenChange }: { open: boolean; onOpenChange: (open: boolean) => void }) {
  ...
  return <aside aria-label="Trusted context rail" aria-hidden={!open} className={cn("hidden shrink-0 flex-col overflow-y-auto border-l border-[#e7e0d7] bg-[#f5f1eb] py-4 transition-[width,padding] duration-200 lg:flex dark:border-border dark:bg-background", open ? "w-[224px] px-3" : "w-[48px] px-1.5")}>
    ...
    {open ? <div className="space-y-3">
      ...
      {isWallet ? <><ContextSection title="Wallet" icon={Wallet} action="Open wallet" to="/wallet"><ContextRow icon={Wallet} title="Balance and points" detail="Review before committing." tone="bg-[#eaf1e9] text-[#55705a]" /></ContextSection><ContextSection title="Cart" icon={ShoppingCart} action="Open cart" to="/cart"><ContextRow icon={ShoppingCart} title="Items ready for review" detail="Nothing committed without approval." tone="bg-[#eaf1e9] text-[#55705a]" /></ContextSection></> : <ContextSection title="Cart" icon={ShoppingCart} action="Open cart" to="/cart"><ContextRow icon={ShoppingCart} title="Items ready for review" detail="Nothing committed without approval." tone="bg-[#eaf1e9] text-[#55705a]" /></ContextSection>}
