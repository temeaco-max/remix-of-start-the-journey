...
export function Composer({
  ...
  return (
    <form
      ...
      className="rounded-[22px] border border-border bg-surface/95 p-2 shadow-[var(--shadow-soft)] backdrop-blur"
    >
      <div className="flex items-center gap-2">
        <button
          ...
          title="Add context"
          disabled={disabled}
          className="grid size-10 shrink-0 place-items-center rounded-full border border-border text-muted-foreground hover:bg-elevated hover:text-foreground disabled:opacity-40"
        >
        ...
        <input
          ...
          placeholder={
            disabled ? "Kurukoo is working…" : dictating ? "Listening for dictation…" : placeholder
          }
          autoComplete="off"
          disabled={disabled}
        ...
        <div className="relative hidden sm:block">
          <button
            ...
            className="flex h-10 items-center gap-1 rounded-full border border-border bg-background px-3 text-[12px] font-medium text-muted-foreground hover:bg-elevated hover:text-foreground disabled:opacity-40"
          >
          ...
          {modeOpen ? (
            <div className="absolute bottom-12 right-0 z-30 w-44 rounded-2xl border border-border bg-surface p-1.5 shadow-[var(--shadow-lift)]">
              <button
                ...
                className="w-full rounded-xl px-3 py-2 text-left text-[12px] hover:bg-elevated"
              >
                Ask Kurukoo
              </button>
              <button
