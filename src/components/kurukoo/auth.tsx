  ...
  return (
    <div className={compact ? "space-y-4" : "space-y-5"}>
      ...
      {step === "identifier" ? (
        <>
          <div
            className="grid grid-cols-2 rounded-xl bg-elevated p-1"
            role="tablist"
          ...
          >
            <button
              ...
              className={`rounded-lg px-3 py-2 text-[11.5px] font-medium ${method === "email" ? "bg-background text-foreground shadow-sm" : "text-muted-foreground"}`}
            >
              ...
              <label className="block text-[11px] font-medium">
                ...
                <div className="relative mt-1.5">
                  ...
                  <input
                    ...
                    className="min-h-11 w-full rounded-xl border border-border bg-background pl-10 pr-3 text-[13px] outline-none focus-visible:ring-2 focus-visible:ring-ring"
                  />
                </div>
              </label>
              <button
        ...
        <div className="space-y-3">
          ...
          <label className="block text-[11px] font-medium">
            ...
            <input
              ...
              maxLength={12}
              className="mt-1.5 min-h-11 w-full rounded-xl border border-border bg-background px-3 text-center text-[18px] tracking-[0.25em] outline-none focus-visible:ring-2 focus-visible:ring-ring"
            />
          </label>
          <button
            type="button"
          ...
          <button
            ...
            className="w-full text-[11px] font-medium text-muted-foreground underline underline-offset-2"
          >
      ...
      {message ? (
        <p
          role="status"
          className="rounded-xl bg-elevated px-3 py-2.5 text-[11px] leading-relaxed text-muted-foreground"
        >
          {message}
        </p>
      ) : null}
...
export function AuthModal({
  ...
  return (
    ...
    >
      <div className="relative max-h-[min(760px,calc(100vh-32px))] w-full max-w-[430px] overflow-y-auto rounded-[24px] bg-background p-6 shadow-[0_24px_80px_rgba(0,0,0,0.24)] sm:p-8">
        <AuthFlow mode={mode} onClose={onClose} />
  ...
  return (
    <div className="mx-auto max-w-md py-6">
      ...
      <p className="mt-2 text-[11.5px] text-muted-foreground">
        Your authenticated session is held by Kurukoo’s secure server cookie, not by the browser UI.
      </p>
    </div>
  );
}
