...
export function FieldDashboard() {
  ...
  return <div className="kurukoo-field min-w-0 pb-10">
    ...
    <section className="field-main-grid" aria-label="Your day">
      ...
      <div className="field-side-stack"><FieldCard className="field-agent-card"><CardHeading eyebrow="With a little help" title="Agent-assisted next steps" action={<span className="field-count">2</span>} /><div className="field-agent-row"><span className="field-agent-icon"><Sparkles className="size-4" /></span><span><strong>Prepare for client call</strong><small>Brief ready, 3 key points</small></span><Link to="/agents">Open</Link></div><div className="field-agent-row"><span className="field-agent-icon field-agent-icon-green"><CheckCircle2 className="size-4" /></span><span><strong>Grocery top-up</strong><small>Based on your list</small></span><Link to="/work">Review</Link></div><Link to="/agents" className="field-see-all">See all suggestions <ArrowRight className="size-3.5" /></Link></FieldCard><FieldCard className="field-people-card"><CardHeading title="Trusted people" action={<Link to="/connect" className="field-card-action">Manage <ArrowRight className="size-3.5" /></Link>} /><div className="field-people-row" aria-label="Trusted people connections are not loaded"><span className="field-person field-person-a" aria-hidden="true" /><span className="field-person field-person-b" aria-hidden="true" /><span className="field-person field-person-c" aria-hidden="true" /><span className="field-person-add">+</span><div><strong>People you choose to keep close</strong><small>Connections appear here when the trusted-people source is available.</small></div></div></FieldCard></div>
    </section>
