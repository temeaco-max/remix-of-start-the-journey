...
const routerDestinations = new Set(["/explore", "/capabilities", "/topics", "/about", "/blog", "/help", "/login", "/signup", "/how-it-works", "/contributors", "/partners", "/pricing", "/contact", "/use-cases", "/opportunities", "/advertising", "/discover"]);
