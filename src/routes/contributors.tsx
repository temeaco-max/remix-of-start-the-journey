...
export const Route = createFileRoute("/contributors")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Understand how contributors can help make Kurukoo more useful and how to join.",
      },
    ],
  }),
...
function ContributorsPage() {
  return (
    <RoleLanding
      ...
      participation={[
        "Add or improve useful knowledge and local context where a contribution workflow is available.",
        "Help with curation, accessibility, moderation or other defined contribution tasks.",
        "Surface gaps, errors and opportunities that would make Kurukoo more useful.",
        "Take on scoped opportunities rather than being expected to moderate or manage everything.",
      ]}
      benefits={[
        "A practical way to contribute skills and local knowledge.",
        "Potential Points or other programme rewards for qualifying activities.",
        "Opportunities to build recognised participation and useful relationships.",
        "A direct role in improving a product intended for real-world use.",
      ]}
      features={[
        "Contributor opportunities",
        "Topics and community context",
        "Scoped microtasks where available",
        "Points and contribution history",
        "Feedback and reporting",
        "Contributor community",
      ]}
      useCases={[
        "A local contributor adds reliable context that helps people understand a place, service or opportunity.",
        "A contributor spots an outdated or misleading piece of information and submits a correction.",
        "Someone with accessibility expertise helps improve a surface so more people can use it.",
        "A contributor takes a defined microtask and receives the appropriate participation credit when the task qualifies.",
      ]}
