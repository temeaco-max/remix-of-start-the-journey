  ...
  head: () => ({
    meta: [
      { title: "Wallet and points — Kurukoo" },
      {
        name: "description",
        content:
          "See Kurukoo points, payments, provider earnings and transaction history in one place.",
      },
      { property: "og:title", content: "Wallet and points — Kurukoo" },
      {
        property: "og:description",
        content:
          "Points support Kurukoo's coordination work. Money stays separate for approved services and purchases.",
      },
    ],
  }),
...
function Metric({
  ...
  return (
    <Panel className="p-4">
      ...
      <p className="mt-1 text-[25px] font-semibold tracking-[-0.03em]">{value}</p>
    ...
    <>
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        ...
        <Metric
          ...
          value="—"
          note="Available when provider payouts are connected"
        />
      </div>
      <Panel className="mt-4 overflow-hidden p-0">
        <div className="flex flex-col gap-4 p-5 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-[15px] font-medium">Choose what the value is for</p>
            <p className="mt-1 text-[13px] leading-relaxed text-muted-foreground">
              Points can cover Kurukoo's coordination work. Provider and business payments remain
              separate and require your approval.
            </p>
          </div>
        ...
        <div className="grid border-t border-border sm:grid-cols-2">
          <div className="p-4 sm:border-r sm:border-border">
            ...
            <p className="mt-2 text-[13.5px] leading-relaxed">
              Used for Kurukoo's coordination work, such as moving a request forward.
            </p>
          </div>
          <div className="p-4">
            <p className="text-[11px] font-medium uppercase tracking-[0.12em] text-muted-foreground">
            ...
            <p className="mt-2 text-[13.5px] leading-relaxed">
              Used for an approved provider, business or other paid transaction.
            </p>
          </div>
        </div>
      </Panel>
      ...
      <section className="mt-8 grid gap-3 sm:grid-cols-2">
        <Panel className="p-4">
          <p className="text-[14px] font-medium">Top-ups and refunds</p>
      ...
      <div className="mt-4 flex justify-end">
        ...
        >
          See request activity <ArrowUpRight className="size-3.5" />
        </Link>
      </div>
    </>
  );
