  ...
  head: () => ({
    meta: [
      { title: "Explore — Kurukoo" },
      {
        name: "description",
        content:
          "Authenticated Explore bridge. Discovery now lives on the public Discover surface.",
      },
    ],
  }),
  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-7 pb-12">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <h2 className="mt-1.5 text-[30px] font-semibold tracking-[-0.04em]">
              Nearby context + useful ideas.
            </h2>
            <p className="mt-3 max-w-2xl text-[13px] leading-6 text-muted-foreground">
              The former Explore content — outcomes, opportunities, nearby context, commerce ideas
              and community context — now lives together on Discover so there is one clear place to
              look and one clear route into Chat / Voice.
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-wrap items-center gap-3">
        <AskKurukoo prompt={q ? `Help me with ${q}.` : "Help me decide what to do next."} />
        <Link
          to="/chat"
