...
export const Route = createFileRoute("/advertise")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Understand what Kurukoo offers advertisers and how to get started.",
      },
    ],
  }),
  ...
  return (
    <RoleLanding
      ...
      participation={[
        ...
        "Review serving, spend and performance only from measurement data Kurukoo actually has.",
      ]}
      benefits={[
        ...
        "Clear sponsored disclosure and a defined campaign lifecycle.",
