      ...
      {tab === "Find help" ? (
        ...
        <div className="mt-4 space-y-6">
          ...
          <section>
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              <Panel className="p-4">
                <p className="text-[13.5px] font-semibold">1. Get discovered</p>
                <p className="mt-1.5 text-[11.5px] leading-relaxed text-muted-foreground">
                  Build a clear profile and let relevant requests find you. Nearby Pulse is optional
                  and temporary.
                </p>
              </Panel>
              <Panel className="p-4">
                <p className="text-[13.5px] font-semibold">2. Accept work</p>
                <p className="mt-1.5 text-[11.5px] leading-relaxed text-muted-foreground">
                  Review the request and approve the work before a commitment is made.
                </p>
              </Panel>
              <Panel className="p-4">
                <p className="text-[13.5px] font-semibold">3. Get paid</p>
                <p className="mt-1.5 text-[11.5px] leading-relaxed text-muted-foreground">
                  Completed paid work can flow through the wallet and payout layer when connected.
                </p>
              </Panel>
            </div>
          </section>
