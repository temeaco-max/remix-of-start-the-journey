...
export const Route = createFileRoute("/providers")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Understand what Kurukoo offers service providers and how to join.",
      },
    ],
  }),
...
function ProvidersPage() {
  return (
    <RoleLanding
      ...
      participation={[
        "List a genuine skill, service or capability.",
        "Make your location, service area and availability useful for discovery when supported.",
        "Respond to suitable requests and coordinate work through Kurukoo.",
        "Build a trusted history through completed work and appropriate feedback.",
      ]}
      benefits={[
        "More opportunities to be discovered when your capability matches demand.",
        "A single place to coordinate customer requests and conversations.",
        "Potential earnings from eligible work, with commercial terms shown before commitment.",
        "A clearer reputation built from real participation rather than invented rankings.",
      ]}
      features={[
        "Provider profile and capability discovery",
        "Requests, offers and coordination",
        "Availability and Go Live when eligible",
        "Chat and provider communication",
        "Work and completion tracking",
        "Reviews and trust signals",
      ]}
      useCases={[
        "A plumber makes their service area and availability discoverable, then receives a suitable repair request.",
        "A mobile food provider responds to a nearby order and coordinates fulfilment through the request lifecycle.",
        "A skilled individual offers a specific service and uses Kurukoo to turn suitable demand into work.",
        "A provider follows an active request, supplies evidence and closes the loop after the work is done.",
      ]}
