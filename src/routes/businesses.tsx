  ...
  head: () => ({
    meta: [
      { title: "Businesses — Kurukoo" },
      {
        name: "description",
        content:
          "Understand what Kurukoo offers businesses and how to bring a business onto the network.",
      },
    ],
  }),
...
function BusinessesPage() {
  return (
    <RoleLanding
      ...
      participation={[
        "Create a useful business presence with accurate products, services, location and operating details.",
        "Respond to suitable requests and keep your team connected to work in progress.",
        "Use discovery, offers and eligible advertising to reach relevant demand.",
        "Build customer relationships from real interactions rather than artificial engagement numbers.",
      ]}
      benefits={[
        "More discoverability when what you offer matches a person's intent or location.",
        "A coordinated place for requests, customer conversations and work.",
        "Opportunities to reach new customers through discovery and sponsored promotion.",
        "Business insights based on the information and activity Kurukoo can actually verify.",
      ]}
      features={[
        "Business profile and discovery",
      ...
      useCases={[
        "A restaurant becomes discoverable when someone asks Kurukoo for food nearby and can respond to an appropriate request.",
        "A repair business receives a suitable job, reviews the request and coordinates the work with the customer.",
        "A retailer promotes a genuine offer in an eligible sponsored placement and reviews actual campaign evidence.",
        "A mobile business uses location and availability signals to be discoverable where it can genuinely serve customers.",
      ]}
