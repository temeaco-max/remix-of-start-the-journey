  ...
  head: () => ({
    meta: [
      { title: "Businesses — Kurukoo" },
      {
        name: "description",
        content:
          "Discover businesses, or run yours on Kurukoo with requests, customers, advertising and analytics.",
      },
    ],
  }),
      ...
      {tab === "Discover" ? (
        ...
        <div className="mt-4 space-y-6">
          ...
          <section className="rounded-2xl border border-border bg-elevated/50 p-4">
            <p className="text-[15px] font-semibold">Your business on Kurukoo</p>
            <p className="mt-1.5 text-[12.5px] leading-relaxed text-muted-foreground">
              Make it easier for people to find what you offer, respond to requests and understand
              demand. Go Live is a temporary availability signal, not a role switch.
            </p>
            <div className="mt-3 flex flex-wrap gap-2">
              <Action variant="primary">Set up business</Action>
              <Link to="/pricing" className={actionClass()}>
                See business plan
              </Link>
              <Link to="/advertising" className={actionClass()}>
                Advertising
              </Link>
            </div>
          </section>
          <div className="grid gap-3 sm:grid-cols-3">
            <StatTile label="Incoming requests" value="0" note="Ready when connected" />
            <StatTile label="Customers" value="0" note="Customer history" />
            <StatTile label="Ad spend" value="£0.00" note="Measured when connected" />
          </div>
          <section>
            ...
            <Rows>
              {[
                ...
                ["Services and products", "What you offer", "/capabilities"],
                ["Team", "Who can respond", "/network"],
                ["Requests and work", "Jobs in progress", "/work"],
                ["Messages", "Customer conversations", "/messages"],
                ["Analytics", "Demand and performance", "/activity"],
                ["Advertising", "Sponsored placements", "/advertising"],
                ["Subscriptions and payments", "Plan and billing", "/subscriptions"],
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              <Link to="/advertising" className={actionClass("primary")}>
                Advertising
              </Link>
