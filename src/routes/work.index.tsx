    ...
    <div className="space-y-6">
        ...
        <div className="relative flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 max-w-2xl text-[13px] text-muted-foreground">
              Requests move here as they are understood, coordinated and completed. Anything
              requiring your approval is clearly marked.
            </p>
          </div>
        </div>
      </section>
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        <Panel className="p-4">
          ...
          <p className="mt-0.5 text-[11.5px] text-muted-foreground">Requests being handled</p>
        </Panel>
        <Panel className="p-4">
          <div className="flex items-center gap-2 text-muted-foreground">
        ...
        <Panel className="p-4">
          ...
          <p className="mt-0.5 text-[11.5px] text-muted-foreground">Finished requests</p>
        </Panel>
      </div>
      ...
      {work.length === 0 ? (
        ...
        <section>
          <div className="mb-3 flex items-center justify-between">
            <h2 className="text-[14px] font-semibold tracking-tight">Your requests</h2>
            <span className="text-[12px] text-muted-foreground">{work.length} total</span>
          </div>
