...
export const Route = createFileRoute("/ad-campaign")({
  head: () => ({
    meta: [
      { title: "Advertisers — Kurukoo" },
      {
        name: "description",
        content: "Understand Kurukoo advertising, who it is for and how to get started.",
      },
    ],
  }),
  ...
  return (
    <RoleLanding
      ...
      participation={[
        ...
        "Choose suitable placements, audience context and campaign goals within Kurukoo's available controls.",
        "Submit creative that meets advertising and moderation requirements.",
        "Review serving, spend and performance only from the measurement data Kurukoo actually has.",
      ]}
      benefits={[
        "Reach audiences in discovery contexts where your offer can be useful.",
        "Connect promotion with Topics, local discovery, offers and creator surfaces where eligible.",
        "A clearer sponsored label and campaign lifecycle rather than hidden promotion.",
        "Potentially turn relevant discovery into visits, enquiries, requests or other supported outcomes.",
      ]}
      features={[
        "Campaign creation through Kurukoo",
        "Sponsored discovery placements",
        "Topic and local context",
        "Creative and moderation workflow",
        "Spend and billing controls",
        "Campaign measurement when available",
      ]}
      useCases={[
        "A local restaurant promotes an offer to people exploring nearby food and relevant Topics.",
        "A service business promotes a seasonal service where people are already looking for that kind of help.",
        "A creator or eligible organisation promotes useful content into relevant discovery surfaces.",
        "A business runs a campaign and reviews actual serving and conversion evidence rather than assumed results.",
      ]}
