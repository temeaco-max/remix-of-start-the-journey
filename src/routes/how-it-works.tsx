...
function HowItWorksPage() {
  return <div className="mx-auto w-full max-w-4xl px-5 py-10 md:px-8 md:py-14">
    ...
    <section className="mt-10 rounded-[24px] border border-border bg-surface p-6"><p className="text-[12px] font-medium text-muted-foreground">The important distinction</p><p className="mt-2 max-w-2xl text-[20px] font-medium tracking-tight">Kurukoo coordinates the work. You remain the authority on meaningful commitments.</p><div className="mt-5 flex flex-wrap gap-2"><Link to="/"><Action variant="primary">Try a request</Action></Link><Link to="/capabilities"><Action>See capabilities</Action></Link></div></section>
