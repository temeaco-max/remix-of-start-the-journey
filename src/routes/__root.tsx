...
const publicSurfacePrefixes = ["/about", "/blog", "/capabilities", "/contributors", "/contact", "/explore", "/help", "/how-it-works", "/legal", "/login", "/partners", "/pricing", "/signup", "/topics", "/use-cases", "/opportunities"];
