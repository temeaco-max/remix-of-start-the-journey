...
function RootComponent() {
  ...
  useEffect(() => {
    const read = () => setAuthenticated(localStorage.getItem("kurukoo-authenticated") === "true");
    read();
  ...
  return <QueryClientProvider client={queryClient}><KurukooProvider>{usePublicShell ? <PublicKurukooShell>{isAnonymousHome ? <PublicHome onSend={savePublicPrompt} /> : <Outlet />}</PublicKurukooShell> : <AppShell><Outlet /></AppShell>}</KurukooProvider></QueryClientProvider>;
}
