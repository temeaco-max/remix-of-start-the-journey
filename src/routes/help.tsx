  ...
  head: () => ({
    meta: [
      { title: "Help — Kurukoo" },
      {
        name: "description",
        content:
          "Learn how Kurukoo works, get help with requests and understand trust, payments, Topics and accounts.",
      },
      { property: "og:title", content: "Help — Kurukoo" },
      {
        property: "og:description",
        content: "Learn how Kurukoo works and get back to what you need done.",
      },
    ],
  }),
  component: HelpPage,
...
const sections: [string, string, string, string][] = [
  ...
  [
    ...
    "Understand how a request becomes work, what Kurukoo can do automatically and where it asks for your decision.",
    "Open Conversation",
  ],
  [
    "Topics and community",
    "Use context carefully",
    "Topics are moderated public context. They can inform a decision, but they do not become proof of current providers, prices or availability.",
    "Browse Topics",
  ],
  [
    "Work and activity",
    "Keep the trail",
    "Follow a request from the first ask through coordination, handovers, approvals and completion.",
    "Open Work",
  ],
  [
    "Money and payments",
    "Stay in control",
    "See prices and payment decisions before anything financial is committed. Approvals stay visible.",
    "See Plans",
  ],
  [
    "Providers and businesses",
    "Understand trust",
    "Provider information, verification and incoming work are kept separate from community discussion and reputation.",
    "Explore Providers",
  ],
];
  ...
  return (
    <div className="w-full">
      <section className="max-w-3xl">
        ...
        <h1 className="mt-2 max-w-3xl font-serif text-[42px] leading-[1.02] tracking-[-0.045em] md:text-[56px]">
          Find the answer, or just ask.
        </h1>
        <p className="mt-4 max-w-2xl text-[16px] leading-relaxed text-muted-foreground">
          A simple place to understand the product, its boundaries and the shortest route back to
        ...
        <div className="grid gap-0 md:grid-cols-[1.15fr_.85fr]">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1.5 text-[13px] leading-relaxed text-muted-foreground">
                  Describe what is confusing you in your own words. The conversation can explain the
                  product and point you to the right surface.
                </p>
                <Action
                  variant="primary"
                  onClick={() => send("I need help understanding Kurukoo.")}
                >
          ...
          <div className="border-t border-border bg-elevated/35 p-5 md:border-l md:border-t-0 md:p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-[13px] font-semibold">Trust is part of the product</p>
                <p className="mt-1.5 text-[12.5px] leading-relaxed text-muted-foreground">
                  Availability, pricing and important commitments are evidence- and approval-led.
                  Community posts stay separate from fulfilment proof.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="mt-10">
        ...
        {list.length ? (
          <div className="grid gap-3 md:grid-cols-2">
            {list.map(([title, note, body, cta], index) => {
              const to =
                index === 0
                  ? "/chat"
                  : title.startsWith("Topics")
                    ...
                    : title.startsWith("Chat")
                      ? "/chat"
                      : title.startsWith("Work")
                        ? "/work"
                        : title.startsWith("Money")
                          ? "/pricing"
                          : title.startsWith("Providers")
                            ? "/providers"
                            : "/how-it-works";
              return (
                <Panel
