...
function MessagesPage() {
  ...
  return (
    <div className="space-y-7 pb-12">
      ...
      />
      <AgentIntelligence compact title="Agent conversation context" maxItems={3} />
      ...
      <IntegrationGap>
        Threads shown here include product-preview conversations. When connected, agent context can
        lead from a request into an approved provider conversation without losing the Work or
