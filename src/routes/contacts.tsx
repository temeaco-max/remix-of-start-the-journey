    ...
    <div className="space-y-7">
          ...
          <div className="flex items-start gap-3.5">
            ...
            <div className="min-w-0 flex-1">
              ...
              <h2 className="mt-1 text-[22px] font-semibold tracking-tight">
                People you can ask Kurukoo to work with.
              </h2>
              <p className="mt-1 max-w-2xl text-[13.5px] leading-5 text-muted-foreground">
                People you have already dealt with can stay connected to future requests,
      ...
      {contacts.length > 0 ? (
        <section>
          <div className="mb-3 flex items-center gap-2">
            ...
            <div>
              <h2 className="text-[16px] font-semibold">People Kurukoo has reached</h2>
              <p className="text-[12.5px] text-muted-foreground">
                Relationships created through real work.
              </p>
            </div>
          </div>
          <Rows>
      ...
      <section>
        <div className="mb-3 px-1">
          <h2 className="text-[17px] font-semibold">Known people & places</h2>
          <p className="mt-0.5 text-[13.5px] text-muted-foreground">
            People and providers you can ask Kurukoo to work with.
          </p>
        </div>
        {filtered.length === 0 ? (
              ...
              <ContactRow
                ...
                right={
                  <span className="flex shrink-0 gap-3 text-[13px] text-muted-foreground">
                    ...
                    <Link to="/calls" className="hover:text-foreground">
                      Call
                    </Link>
      ...
      <IntegrationGap>
        Contacts shown here include prototype relationships. Real contacts will come from verified
        interactions and connected address books.
      </IntegrationGap>
    </div>
  );
}
