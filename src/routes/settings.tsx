...
function SettingsPage() {
  ...
  return (
    <>
      ...
      <div className="mt-4">
        {tab === "Account" && <><SettingIntro icon={UserRound} eyebrow="Your identity" title="Make Kurukoo feel like yours" description="Manage the details Kurukoo uses to represent you and keep your account secure." /><Rows><SettingsRow title="Profile" description="Name, photo and how people see you" control={<Action>Edit</Action>} /><SettingsRow title="Email and phone" description="Used for confirmations" control={<Action>Edit</Action>} /><SettingsRow title="Security" description="Password, sessions and two-factor" control={<Action>Manage</Action>} /><SettingsRow title="Language" description="English (UK)" control={<Action>Change</Action>} /><SettingsRow title="Memory" description="What Kurukoo remembers about you" control={<Link to="/memory"><Action>Open</Action></Link>} /></Rows></>}
