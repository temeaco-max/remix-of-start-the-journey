...
export const Route = createFileRoute("/creators")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Understand how creators can publish, reach people and participate in Kurukoo.",
      },
    ],
  }),
...
function CreatorsPage() {
  return (
    <RoleLanding
      ...
      participation={[
        "Publish useful videos, ideas and other eligible creator content.",
        "Connect content with relevant Topics and discovery surfaces.",
        "Build an audience through creator and community participation.",
        "Take part in eligible campaigns, opportunities or commerce where the product supports them.",
      ]}
      benefits={[
        "A place for useful content to meet people with an active need or interest.",
        "Creator discovery and audience-building tools.",
        "Potential earnings or campaign opportunities where you qualify.",
        "A closer connection between content, Topics and actions people actually take.",
      ]}
      features={[
        "Creator profile and channel",
        "Watch and video discovery",
        "Topics and placement",
        "Audience and subscriber tools",
        "Creator opportunities",
        "Earnings and campaign surfaces",
      ]}
      useCases={[
        "A creator publishes a practical video that helps someone solve a common local problem.",
        "A specialist builds a channel around useful guidance and connects relevant videos to Topics.",
        "A creator participates in an eligible campaign where the commercial relationship is disclosed.",
        "A viewer discovers a useful creator through Kurukoo and continues into Chat or another supported action.",
      ]}
