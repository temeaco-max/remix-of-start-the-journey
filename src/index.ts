...
void ensureCommercialSchema().then(() => ensureCommercialCatalog()).catch(error => console.error('[Kurukoo Startup] Commercial catalog initialization failed:', error));
