...
export const CLIENT_SURFACES: readonly ClientSurface[] = [
  ...
  { id: 'web-tasks', label: 'Tasks', family: 'web', route: '/work', primaryNavigation: 'tasks', semanticOwners: ['task', 'agentRuntime', 'reminderService'], states: ['represented', 'implemented'], responsive: true },
