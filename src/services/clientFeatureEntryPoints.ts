...
const RAW_FEATURE_ENTRYPOINTS: ReadonlyArray<[string, string, string, string, string, FeatureEntrypoint['primarySurface']]> = [
  ...
  ['emergency','Safety / urgent help','Urgent situations use the safety boundary and never imply emergency-service fulfilment.','/explore/emergency','/safety','safety'],
  ...
  ['prayer','Prayer and spiritual support','Prayer is a first-class agent using the canonical Agent Runtime, voice and artifacts.','/explore/spiritual','/prayer','chat'],
];
