...
const blueprintRules: Array<[RegExp,string]> = [
  ...
  [/\b(iphone|android|samsung|pixel|phone|mobile).{0,40}\b(repair(?:ed|ing)?|broken|damaged|smashed|fix|not working|won't turn on|not charging)\b/i,'phone_repairer'],
  ...
  [/\b(prayer|pray|praying|dua|devotional)\b/i,'prayer'],
