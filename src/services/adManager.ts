...
export async function seedDemoAdCampaigns(): Promise<void> {
    ...
    const campaigns = [
        ...
        ['Support home from wherever you are', 'Coordinate trusted local help, errands and practical support for family across borders.', 'diaspora', 'Ask Kurukoo to coordinate', '/chat?prompt=Help%20me%20coordinate%20support%20for%20family%20back%20home', 'public_diaspora', 'diaspora', 88, '/assets/chat/campaign-diaspora-remittance.jpg'],
        ['Keep family care connected', 'Arrange a thoughtful local check-in or care visit for someone important to you.', 'care abroad', 'Arrange a care check-in', '/chat?prompt=Help%20me%20arrange%20a%20care%20check-in%20for%20family', 'public_diaspora', 'diaspora', 84, '/assets/chat/campaign-diaspora-care.jpg'],
        ['Trusted eyes on your home', 'Coordinate verified maintenance and local property support while you are away.', 'property abroad', 'Find property support', '/chat?prompt=Help%20me%20find%20trusted%20property%20support', 'public_diaspora', 'diaspora', 80, '/assets/chat/campaign-diaspora-property.jpg'],
        ['Plan the moments that matter', 'Connect celebrations, catering and local coordination with the people you love.', 'celebration', 'Plan something together', '/chat?prompt=Help%20me%20plan%20a%20family%20celebration', 'public_diaspora', 'diaspora', 76, '/assets/chat/campaign-diaspora-celebration.jpg'],
        ['Back a local business', 'Help a trusted maker, seller or digital worker serve customers across distance.', 'support business', 'Explore local businesses', '/chat?prompt=Show%20me%20local%20businesses%20I%20can%20support', 'public_diaspora', 'diaspora', 72, '/assets/chat/campaign-diaspora-business.jpg'],
    ];
