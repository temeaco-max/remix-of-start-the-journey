...
export const KURUKOO_ROLES: KurukooRole[] = [
  ...
  },
  {
    ...
    actions: [
      {
        title: "Go Live",
        detail: "Let nearby people discover your availability.",
        to: "/discover",
      },
  ...
  },
  {
    ...
    description:
      "Help make Kurukoo more useful through knowledge, participation and community signals.",
  ...
  },
  {
    ...
    actions: [
      {
        title: "Explore local demand",
        detail: "Understand where people are looking.",
        to: "/discover",
      },
      {
  ...
  },
  {
    id: "ambassador",
    title: "Ambassadors",
    shortTitle: "Grow Kurukoo locally",
    description:
      "Introduce Kurukoo, build awareness and help more people discover how it can work for them.",
    homeLabel: "Grow Kurukoo locally",
    actions: [
      {
      ...
      {
        title: "See opportunities",
        detail: "Find local ways to participate.",
        to: "/opportunities",
      },
    ],
  },
