    ...
    <>
      ...
      <Panel className="p-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-[14px] font-medium">Your work follows you</p>
            <p className="mt-0.5 text-[12.5px] text-muted-foreground">
              Files belong to the conversations and work that created them.
            </p>
          </div>
        </div>
      ...
      <Panel className="mt-8 p-4">
        ...
        <p className="mt-1 text-[13.5px] text-muted-foreground">
          Files currently sit in temporary Kurukoo storage. Connect a provider when you want a
          persistent destination.
        </p>
        <Link to="/connect" className={cn("mt-3 inline-block", actionClass("primary"))}>
          Open Connect
        </Link>
      </Panel>
      <IntegrationGap>
